...
enum target {
  ...
  TGT_X86_64_WINDOWS_NASM = (7 << 1) | 0,
  TGT_X86_64_WINDOWS_AS   = (8 << 1) | 0,
  TGT_X86_64_WINDOWS_FASM = (9 << 1) | 0,
  TGT_X86_64_WINDOWS_MASM = (10 << 1) | 0,
  TGT_X86_WINDOWS_NASM    = (11 << 1) | 0,
  TGT_X86_WINDOWS_AS      = (12 << 1) | 0,
  TGT_X86_WINDOWS_FASM    = (13 << 1) | 0,
  TGT_X86_WINDOWS_MASM    = (14 << 1) | 0,
  */

  /* TODO: ARM, aarch64, RISCV, 6502 (?), etc. */
};
